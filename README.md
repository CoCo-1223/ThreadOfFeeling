...
기존 경쟁 서비스(buddy-in 등)와의 비교 우위 요소입니다.

| 항목 | 타사 서비스 (buddy-in) | **Thread of Feeling** |
| :---: | :--- | :--- |
| **대상** | 성인/청소년 (정신건강, 우울 완화) | **자폐 아동** (감정 인식, 사회성 학습) |
| **방식** | 텍스트/음성 대화, 저널링 | **제스처 인식** + **상황 시뮬레이션 게임** |
| **콘텐츠** | 상담 및 기록의 연장선 | **시나리오 게임** + **제스처 퀴즈** + **보상(하우징)** |
